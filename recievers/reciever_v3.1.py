...
def receive_message():
    ...
    detected_homography_matrix = None
    warped_frame_shape = (sender_output_height, sender_output_width)
...
#   ECC reference image generation
    ...
    while True:
        ...
        reference_images_match = detect_ecc_reference_image(frame, ecc_reference_image) # Check if the frame matches good enough with the reference image
